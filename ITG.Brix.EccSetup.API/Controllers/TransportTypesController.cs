...
namespace ITG.Brix.EccSetup.API.Controllers
{
    ...
    public class TransportTypesController : Controller
    {
        ...
        public TransportTypesController(IApiResult apiResult)
        {
            _apiResult = apiResult ?? throw new ArgumentNullException(nameof(apiResult));
        }

        [HttpGet]
        [ProducesResponseType(typeof(TransportTypeModel), (int)HttpStatusCode.OK)]
        [ProducesResponseType(typeof(ResponseError), (int)HttpStatusCode.BadRequest)]
        public async Task<IActionResult> List([FromQuery] ListTransportTypeFromQuery query)
        {
            var request = new ListTransportTypeRequest(query);
        ...
        [ProducesResponseType(typeof(ResponseError), (int)HttpStatusCode.BadRequest)]
        public async Task<IActionResult> Create([FromQuery] CreateTransportTypeFromQuery query,
                                                [FromBody] CreateTransportTypeFromBody body)
        {
            var request = new CreateTransportTypeRequest(query, body);
