...
namespace ITG.Brix.EccSetup.Application.Cqs.Queries.Validators.OperationalDepartments
{
    public class ListOperationalDepartmentQueryValidator : AbstractValidator<ListOperationalDepartmentQuery>
    {
        public ListOperationalDepartmentQueryValidator()
        {
