...
namespace ITG.Brix.EccSetup.Application.Cqs.Queries.Validators.OperatorActivity
{
    public class ListOperatorActivityQueryValidator : AbstractValidator<ListOperatorActivityQuery>
    {
        public ListOperatorActivityQueryValidator()
        {
