...
namespace ITG.Brix.EccSetup.API.Context.Services.Requests.Models
{
    ...
    {
        private readonly GetSourceFromRoute _route;
        private readonly GetSourceFromQuery _query;

        public GetSourceRequest(GetSourceFromRoute route, GetSourceFromQuery query)
        {
