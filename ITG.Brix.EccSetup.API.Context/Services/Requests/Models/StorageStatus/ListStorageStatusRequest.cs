...
{
    public class ListStorageStatusRequest
    {
        private readonly ListStorageStatusFromQuery _query;

        public ListStorageStatusRequest(ListStorageStatusFromQuery query)
        {
