...
{
    public class ListTransportTypeRequest
    {
        private readonly ListTransportTypeFromQuery _query;

        public ListTransportTypeRequest(ListTransportTypeFromQuery query)
        {
