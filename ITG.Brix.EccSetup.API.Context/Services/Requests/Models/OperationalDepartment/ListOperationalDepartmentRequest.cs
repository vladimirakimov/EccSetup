...
{
    public class ListOperationalDepartmentRequest
    {
        private readonly ListOperationalDepartmentFromQuery _query;

        public ListOperationalDepartmentRequest(ListOperationalDepartmentFromQuery query)
        {
