...
{
    public class CreateStorageStatusRequestValidator : AbstractRequestValidator<CreateStorageStatusRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public CreateStorageStatusRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as CreateStorageStatusRequest;
