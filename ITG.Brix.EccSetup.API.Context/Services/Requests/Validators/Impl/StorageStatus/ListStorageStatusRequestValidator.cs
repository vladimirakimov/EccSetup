...
{
    public class ListStorageStatusRequestValidator : AbstractRequestValidator<ListStorageStatusRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public ListStorageStatusRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as ListStorageStatusRequest;
