...
{
    public class ListLocationRequestValidator : AbstractRequestValidator<ListLocationRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public ListLocationRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as ListLocationRequest;
