...
{
    public class GetFlowRequestValidator : AbstractRequestValidator<GetFlowRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public GetFlowRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as GetFlowRequest;
