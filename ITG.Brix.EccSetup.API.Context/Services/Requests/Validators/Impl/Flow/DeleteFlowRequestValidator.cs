...
{
    public class DeleteFlowRequestValidator : AbstractRequestValidator<DeleteFlowRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public DeleteFlowRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as DeleteFlowRequest;
