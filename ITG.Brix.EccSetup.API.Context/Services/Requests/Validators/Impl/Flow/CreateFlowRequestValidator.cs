...
{
    public class CreateFlowRequestValidator : AbstractRequestValidator<CreateFlowRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public CreateFlowRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as CreateFlowRequest;
