...
{
    public class ListProductionSiteRequestValidator : AbstractRequestValidator<ListProductionSiteRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public ListProductionSiteRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as ListProductionSiteRequest;
