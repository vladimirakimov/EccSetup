...
{
    public class ListSourceRequestValidator : AbstractRequestValidator<ListSourceRequest>
    {

        private readonly IRequestComponentValidator _requestComponentValidator;

        public ListSourceRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as ListSourceRequest;
