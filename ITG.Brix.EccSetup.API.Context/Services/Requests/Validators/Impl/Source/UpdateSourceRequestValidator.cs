...
{
    public class UpdateSourceRequestValidator : AbstractRequestValidator<UpdateSourceRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public UpdateSourceRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as UpdateSourceRequest;
