...
{
    public class CreateBusinessUnitRequestValidator : AbstractRequestValidator<CreateBusinessUnitRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public CreateBusinessUnitRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as CreateBusinessUnitRequest;
