...
{
    public class UpdateBusinessUnitRequestValidator : AbstractRequestValidator<UpdateBusinessUnitRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public UpdateBusinessUnitRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
