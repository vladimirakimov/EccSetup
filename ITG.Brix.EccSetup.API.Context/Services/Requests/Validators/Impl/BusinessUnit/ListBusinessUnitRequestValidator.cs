...
{
    public class ListBusinessUnitRequestValidator : AbstractRequestValidator<ListBusinessUnitRequest>
    {

        private readonly IRequestComponentValidator _requestComponentValidator;

        public ListBusinessUnitRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as ListBusinessUnitRequest;
