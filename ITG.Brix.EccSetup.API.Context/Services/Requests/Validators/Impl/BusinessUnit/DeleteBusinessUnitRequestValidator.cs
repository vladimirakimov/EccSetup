...
{
    public class DeleteBusinessUnitRequestValidator : AbstractRequestValidator<DeleteBusinessUnitRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public DeleteBusinessUnitRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as DeleteBusinessUnitRequest;
