...
{
    public class ListSiteRequestValidator : AbstractRequestValidator<ListSiteRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public ListSiteRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as ListSiteRequest;
