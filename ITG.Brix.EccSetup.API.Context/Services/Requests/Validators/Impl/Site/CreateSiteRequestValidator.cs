...
{
    public class CreateSiteRequestValidator : AbstractRequestValidator<CreateSiteRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public CreateSiteRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as CreateSiteRequest;
