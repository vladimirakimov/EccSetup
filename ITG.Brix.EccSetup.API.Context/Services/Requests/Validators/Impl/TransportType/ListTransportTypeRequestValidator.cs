...
{
    public class ListTransportTypeRequestValidator : AbstractRequestValidator<ListTransportTypeRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public ListTransportTypeRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as ListTransportTypeRequest;
