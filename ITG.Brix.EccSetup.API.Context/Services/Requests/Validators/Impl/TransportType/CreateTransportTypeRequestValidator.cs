...
{
    public class CreateTransportTypeRequestValidator : AbstractRequestValidator<CreateTransportTypeRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public CreateTransportTypeRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
