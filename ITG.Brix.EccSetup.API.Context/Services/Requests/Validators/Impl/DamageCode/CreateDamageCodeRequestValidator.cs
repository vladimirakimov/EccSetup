...
{
    public class CreateDamageCodeRequestValidator : AbstractRequestValidator<CreateDamageCodeRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public CreateDamageCodeRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as CreateDamageCodeRequest;
