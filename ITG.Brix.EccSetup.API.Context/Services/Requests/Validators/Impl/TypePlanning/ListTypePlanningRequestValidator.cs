...
{
    public class ListTypePlanningRequestValidator : AbstractRequestValidator<ListTypePlanningRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public ListTypePlanningRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as ListTypePlanningRequest;
