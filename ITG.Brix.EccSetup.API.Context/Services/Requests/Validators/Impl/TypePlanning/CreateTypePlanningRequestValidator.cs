...
{
    public class CreateTypePlanningRequestValidator : AbstractRequestValidator<CreateTypePlanningRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public CreateTypePlanningRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as CreateTypePlanningRequest;
