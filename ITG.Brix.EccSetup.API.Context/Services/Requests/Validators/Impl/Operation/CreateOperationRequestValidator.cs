...
{
    public class CreateOperationRequestValidator : AbstractRequestValidator<CreateOperationRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public CreateOperationRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as CreateOperationRequest;
