...
{
    public class DeleteOperationRequestValidator : AbstractRequestValidator<DeleteOperationRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public DeleteOperationRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as DeleteOperationRequest;
