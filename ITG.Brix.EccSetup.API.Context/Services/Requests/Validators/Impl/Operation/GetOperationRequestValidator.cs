...
{
    public class GetOperationRequestValidator : AbstractRequestValidator<GetOperationRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public GetOperationRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as GetOperationRequest;
