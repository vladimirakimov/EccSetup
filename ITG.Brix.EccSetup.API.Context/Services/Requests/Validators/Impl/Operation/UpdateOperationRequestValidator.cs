...
{
    public class UpdateOperationRequestValidator : AbstractRequestValidator<UpdateOperationRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public UpdateOperationRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as UpdateOperationRequest;
