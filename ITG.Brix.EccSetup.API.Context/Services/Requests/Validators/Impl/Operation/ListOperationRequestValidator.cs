...
{
    public class ListOperationRequestValidator : AbstractRequestValidator<ListOperationRequest>
    {

        private readonly IRequestComponentValidator _requestComponentValidator;

        public ListOperationRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as ListOperationRequest;
