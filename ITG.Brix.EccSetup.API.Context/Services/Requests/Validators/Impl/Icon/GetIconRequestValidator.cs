...
{
    public class GetIconRequestValidator : AbstractRequestValidator<GetIconRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public GetIconRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as GetIconRequest;
