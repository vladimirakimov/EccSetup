...
{
    public class CreateIconRequestValidator : AbstractRequestValidator<CreateIconRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public CreateIconRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as CreateIconRequest;
