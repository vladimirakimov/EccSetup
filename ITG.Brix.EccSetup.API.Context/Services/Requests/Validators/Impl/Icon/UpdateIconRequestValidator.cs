...
{
    public class UpdateIconRequestValidator : AbstractRequestValidator<UpdateIconRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public UpdateIconRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as UpdateIconRequest;
