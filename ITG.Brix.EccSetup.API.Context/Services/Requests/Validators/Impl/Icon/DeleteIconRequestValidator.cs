...
{
    public class DeleteIconRequestValidator : AbstractRequestValidator<DeleteIconRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public DeleteIconRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as DeleteIconRequest;
