...
{
    public class UploadFileRequestValidator : AbstractRequestValidator<UploadFileRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public UploadFileRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
