...
{
    public class ListCustomerRequestValidator : AbstractRequestValidator<ListCustomerRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public ListCustomerRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as ListCustomerRequest;
