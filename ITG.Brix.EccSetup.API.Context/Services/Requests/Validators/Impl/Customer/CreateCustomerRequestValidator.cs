...
{
    public class CreateCustomerRequestValidator : AbstractRequestValidator<CreateCustomerRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public CreateCustomerRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as CreateCustomerRequest;
