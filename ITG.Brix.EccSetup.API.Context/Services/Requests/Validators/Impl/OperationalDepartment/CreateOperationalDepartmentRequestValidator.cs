...
{
    public class CreateOperationalDepartmentRequestValidator : AbstractRequestValidator<CreateOperationalDepartmentRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public CreateOperationalDepartmentRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as CreateOperationalDepartmentRequest;
