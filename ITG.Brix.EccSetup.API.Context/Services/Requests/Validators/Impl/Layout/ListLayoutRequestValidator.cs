...
{
    public class ListLayoutRequestValidator : AbstractRequestValidator<ListLayoutRequest>
    {

        private readonly IRequestComponentValidator _requestComponentValidator;

        public ListLayoutRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as ListLayoutRequest;
