...
{
    public class UpdateLayoutRequestValidator : AbstractRequestValidator<UpdateLayoutRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public UpdateLayoutRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as UpdateLayoutRequest;
