...
{
    public class GetLayoutRequestValidator : AbstractRequestValidator<GetLayoutRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public GetLayoutRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as GetLayoutRequest;
