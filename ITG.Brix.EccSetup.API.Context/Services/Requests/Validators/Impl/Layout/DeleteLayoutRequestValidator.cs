...
{
    public class DeleteLayoutRequestValidator : AbstractRequestValidator<DeleteLayoutRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public DeleteLayoutRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as DeleteLayoutRequest;
