...
namespace ITG.Brix.EccSetup.API.Context.Services.Requests.Validators.Components.Impl
{
    public class RequestComponentValidator : IRequestComponentValidator
    {
        ...
        public ValidationResult FileMediaExtension(string extension)
        {
            ValidationResult result = null;

            var allowedExtensions = new List<string> { ".jpg", ".jpeg", ".3gp", ".mp4", ".mpg", ".bmp", ".png", ".gif" };
            ...
            if (!allowedExtensions.Contains(extension))
            {
                result = new ValidationResult
                {
                    ServiceError = ServiceError.InvalidFileExtension,
                    Errors = new List<Failure>() {
                        new Failure{
