...
namespace ITG.Brix.EccSetup.API.Context.Bases
{
    ...
    public class ServiceError
    {
        ...
        public static readonly ServiceError InvalidFileExtension = new ServiceError(Consts.Failure.ServiceErrorCode.InvalidFileExtension, i18n(Consts.Failure.ServiceErrorCode.InvalidFileExtension));
