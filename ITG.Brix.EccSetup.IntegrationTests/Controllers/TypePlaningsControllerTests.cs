...
namespace ITG.Brix.EccSetup.IntegrationTests.Controllers
{
    ...
    public class TypePlaningsControllerTests
    {
        ...
        {
            DatabaseHelper.Init("TypePlannings");
        ...
        public async Task ListAllShouldSucceed()
        {
            // Arrange
            var apiVersion = "1.0";
            await ControllerHelper.CreateTypePlanning("TestCode", "TestName", "TestSource");

            // Act
            var response = await _client.GetAsync(string.Format("api/typeplannings?api-version={0}", apiVersion));
            var responseBody = await response.Content.ReadAsStringAsync();
            var typePlanningsModel = JsonConvert.DeserializeObject<TypePlanningsModel>(responseBody);

            // Assert
            response.StatusCode.Should().Be(HttpStatusCode.OK);
            typePlanningsModel.Value.Should().HaveCount(1);
            typePlanningsModel.Count.Should().Be(1);
            typePlanningsModel.NextLink.Should().BeNull();
        }
        ...
        public async Task ListShouldFailWhenQueryApiVersionIsMissing()
        {
            ...
            // Act
            var response = await _client.GetAsync("api/typeplannings");
        ...
        public async Task ListWithFilterShouldSucceed(string filter, int countResult)
        {
            ...
            {
                await ControllerHelper.CreateTypePlanning(code + c, name, source);
            }

            // Act
            var response = await _client.GetAsync(string.Format("api/typeplannings?api-version={0}&$filter={1}", apiVersion, filter));
            var responseBody = await response.Content.ReadAsStringAsync();
            var typePlanningsModel = JsonConvert.DeserializeObject<TypePlanningsModel>(responseBody);

            // Assert
            response.StatusCode.Should().Be(HttpStatusCode.OK);
            typePlanningsModel.Value.Should().HaveCount(countResult);
            typePlanningsModel.Count.Should().Be(countResult);
            typePlanningsModel.NextLink.Should().BeNull();
        }
        ...
        public async Task ListWithSkipAndTopShouldSucceed(int skip, int top, int countResult)
        {
            ...
            // Act
            var response = await _client.GetAsync(string.Format("api/typeplannings?api-version={0}&$skip={1}&$top={2}", apiVersion, skip, top));
            var responseBody = await response.Content.ReadAsStringAsync();
            var typePlanningsModel = JsonConvert.DeserializeObject<TypePlanningsModel>(responseBody);
        ...
        public async Task ListWithFilterSkipTopShouldSucceed(string filter, int skip, int top, int countResult)
        {
            ...
            // Act
            var response = await _client.GetAsync(string.Format("api/typeplannings?api-version={0}&$filter={1}&$skip={2}&$top={3}", apiVersion, filter, skip, top));
            var responseBody = await response.Content.ReadAsStringAsync();
            var typePlanningsModel = JsonConvert.DeserializeObject<TypePlanningsModel>(responseBody);
        ...
        public async Task ListShouldSucceedWhenQueryTopPresentButUnset(string top)
        {
            ...
            // Act
            var response = await _client.GetAsync(string.Format("api/typeplannings?api-version={0}&$top={1}", apiVersion, top));
        ...
        public async Task ListShouldSucceedWhenQuerySkipPresentButUnset(string skip)
        {
            ...
            // Act
            var response = await _client.GetAsync(string.Format("api/typeplannings?api-version={0}&$skip={1}", apiVersion, skip));
        ...
        public async Task CreateShouldFailWhenBodyIsNonJsonContentType()
        {
            ...
            // Act
            var response = await _client.PostAsync(string.Format("api/typeplannings?api-version={0}", apiVersion), new StringContent(jsonBody, Encoding.UTF8, "text/plain"));
            var responseBody = await response.Content.ReadAsStringAsync();
        ...
        public async Task CreateShouldFailWhenQueryApiVersionIsMissing()
        {
            ...
            // Act
            var response = await _client.PostAsync("api/typeplannings", new StringContent(jsonBody, Encoding.UTF8, "application/json"));
            var responseBody = await response.Content.ReadAsStringAsync();
            ...
            var expectedError = new ResponseError
            {
                Error = new ResponseErrorBody
                {
                    ...
                    Details = new List<ResponseErrorField>
                    {
                        ...
                        {
                            Code = "invalid-input",
                            Message = ValidationFailures.TypePlanningCodeMandatory,
                            Target = "code"
                        }
                    }
                }
            ...
            var expectedError = new ResponseError
            {
                Error = new ResponseErrorBody
                {
                    ...
                    Details = new List<ResponseErrorField>
                    {
                        ...
                        {
                            Code = "invalid-input",
                            Message = ValidationFailures.TypePlanningSourceMandatory,
                            Target = "source"
                        }
                    }
                }
            ...
            var expectedError = new ResponseError
            {
                Error = new ResponseErrorBody
                {
                    ...
                    Details = new List<ResponseErrorField>
                    {
                        ...
                        {
                            Code = "invalid-input",
                            Message = ValidationFailures.TypePlanningNameMandatory,
                            Target = "name"
                        }
                    }
                }
        ...
        public async Task CreateShouldFailWhenCodeAndSourceAlreadyExists()
        {
            ...
            string source = "TSource";
            var apiVersion = "1.0";
            await ControllerHelper.CreateTypePlanning(code, name, source);
