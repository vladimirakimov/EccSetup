...
namespace ITG.Brix.EccSetup.IntegrationTests.Controllers
{
    ...
    public class SourcesControllerTests
    {
        ...
        public async Task ListAllShouldSucceed()
        {
            // Arrange
            var apiVersion = "1.0";
            await ControllerHelper.CreateSource("Name", "Description");

            // Act
            var response = await _client.GetAsync(string.Format("api/sources?api-version={0}", apiVersion));
            var responseBody = await response.Content.ReadAsStringAsync();
            var sourcesModel = JsonConvert.DeserializeObject<SourcesModel>(responseBody);

            // Assert
            response.StatusCode.Should().Be(HttpStatusCode.OK);
            sourcesModel.Value.Should().HaveCount(1);
            sourcesModel.Count.Should().Be(1);
            sourcesModel.NextLink.Should().BeNull();
        }
        ...
        public async Task ListWithFilterShouldSucceed(string filter, int countResult)
        {
            ...
            {
                await ControllerHelper.CreateSource(name + c, description + c);
            }


            // Act
            var response = await _client.GetAsync(string.Format("api/sources?api-version={0}&$filter={1}", apiVersion, filter));
            var responseBody = await response.Content.ReadAsStringAsync();
            var sourcesModel = JsonConvert.DeserializeObject<SourcesModel>(responseBody);

            // Assert
            response.StatusCode.Should().Be(HttpStatusCode.OK);
            sourcesModel.Value.Should().HaveCount(countResult);
            sourcesModel.Count.Should().Be(countResult);
            sourcesModel.NextLink.Should().BeNull();
        }
        ...
        public async Task ListWithSkipAndTopShouldSucceed(int skip, int top, int countResult)
        {
            ...
            // Act
            var response = await _client.GetAsync(string.Format("api/sources?api-version={0}&$skip={1}&$top={2}", apiVersion, skip, top));
            var responseBody = await response.Content.ReadAsStringAsync();
            var sourcesModel = JsonConvert.DeserializeObject<SourcesModel>(responseBody);
        ...
        public async Task ListWithFilterSkipTopShouldSucceed(string filter, int skip, int top, int countResult)
        {
            ...
            // Act
            var response = await _client.GetAsync(string.Format("api/sources?api-version={0}&$filter={1}&$skip={2}&$top={3}", apiVersion, filter, skip, top));
            var responseBody = await response.Content.ReadAsStringAsync();
            var sourcesModel = JsonConvert.DeserializeObject<SourcesModel>(responseBody);
        ...
        public async Task ListShouldSucceedWhenQueryTopPresentButUnset(string top)
        {
            ...
            // Act
            var response = await _client.GetAsync(string.Format("api/sources?api-version={0}&$top={1}", apiVersion, top));
        ...
        public async Task ListShouldSucceedWhenQuerySkipPresentButUnset(string skip)
        {
            ...
            // Act
            var response = await _client.GetAsync(string.Format("api/sources?api-version={0}&$skip={1}", apiVersion, skip));
        ...
        public async Task GetShouldSucceed()
        {
            ...
            var createdRecordResult = await ControllerHelper.CreateSource(name, description);
            var routeId = createdRecordResult.Id;
            var eTag = createdRecordResult.ETag;


            // Act
            var response = await _client.GetAsync(string.Format("api/sources/{0}?api-version={1}", routeId, apiVersion));
            var responseBody = await response.Content.ReadAsStringAsync();
            var businessUnitModel = JsonConvert.DeserializeObject<SourceModel>(responseBody);
        ...
        public async Task GetShouldFailWhenRouteIdIsInvalid()
        {
            ...
            // Act
            var response = await _client.GetAsync(string.Format("api/sources/{0}", routeId));
            var body = await response.Content.ReadAsStringAsync();
            var error = JsonConvert.DeserializeObject<ResponseError>(body);
            ...
            var expectedError = new ResponseError
            {
                Error = new ResponseErrorBody
                {
                    ...
                    Details = new List<ResponseErrorField>
                    {
                        ...
                        {
                            Code = Consts.Failure.Detail.Code.NotFound,
                            Message = CustomFailures.SourceNotFound,
                            Target = Consts.Failure.Detail.Target.Id
                        }
                    }
                }
        ...
        public async Task CreateShouldFailWhenBodyIsNonJsonContentType()
        {
            ...
            // Act
            var response = await _client.PostAsync(string.Format("api/sources?api-version={0}", apiVersion), new StringContent(jsonBody, Encoding.UTF8, "text/plain"));
            var responseBody = await response.Content.ReadAsStringAsync();
        ...
        public async Task CreateShouldFailWhenQueryApiVersionIsMissing()
        {
            ...
            // Act
            var response = await _client.PostAsync("api/sources", new StringContent(jsonBody, Encoding.UTF8, "application/json"));
            var responseBody = await response.Content.ReadAsStringAsync();
            ...
            var expectedError = new ResponseError
            {
                Error = new ResponseErrorBody
                {
                    ...
                    Details = new List<ResponseErrorField>
                    {
                        ...
                        {
                            Code = "invalid-input",
                            Message = ValidationFailures.SourceNameMandatory,
                            Target = "name"
                        }
                    }
                }
            ...
            var expectedError = new ResponseError
            {
                Error = new ResponseErrorBody
                {
                    ...
                    Details = new List<ResponseErrorField>
                    {
                        ...
                        {
                            Code = "invalid-input",
                            Message = ValidationFailures.SourceNameCannotStartOrEndWithWhiteSpace,
                            Target = "name"
                        }
                    }
                }
        ...
        [TestMethod]
        public async Task CreateShouldFailWhenDescriptionIsNull()
        {
            // Arrange
            var name = "name";
            ...
            var expectedError = new ResponseError
            {
                Error = new ResponseErrorBody
                {
                    ...
                    Details = new List<ResponseErrorField>
                    {
                        ...
                        {
                            Code = "invalid-input",
                            Message = ValidationFailures.SourceDescriptionMandatory,
                            Target = "description"
                        }
                    }
                }
        ...
        [TestMethod]
        public async Task CreateShouldFailWhenDescriptionIsEmpty()
        {
            // Arrange
            var name = "name";
        ...
        [TestMethod]
        public async Task CreateShouldFailWhenDescriptionIsIsWhitespace()
        {
            // Arrange
            var name = "name";
            var description = "   ";
        ...
        public async Task UpdateShouldSucceed()
        {
            ...
            var response = await _client.PatchAsync(string.Format("api/sources/{0}?api-version={1}", routeId, apiVersion), new StringContent(jsonInString, Encoding.UTF8, "application/json"));
            var body = await response.Content.ReadAsStringAsync();
        ...
        [TestMethod]
        public async Task UpdateDescriptionShouldSucceed()
        {
            // Arrange
            var name = "Name";
            var description = "Description";
            ...
            var jsonObj = new { description = "UpdatedDescription" };
            string jsonInString = JsonConvert.SerializeObject(jsonObj);
        ...
        [TestMethod]
        public async Task UpdateBusinessUnitsShouldSucceed()
        {
            // Arrange
            var name = "Name";
            var description = "Description";
            ...
            var jsonObj = new { businessUnits = new[] { "SomeBusinessUnit" } };
            string jsonInString = JsonConvert.SerializeObject(jsonObj);
        ...
        public async Task UpdateShouldFailWhenBodyIsNonJsonContentType()
        {
            ...
            // Act
            _client.DefaultRequestHeaders.Add("If-Match", ifmatch);
            var response = await _client.PatchAsync(string.Format("api/sources/{0}?api-version={1}", routeId, apiVersion), new StringContent(jsonInString, Encoding.UTF8, "text/plain"));
            var body = await response.Content.ReadAsStringAsync();
            var error = JsonConvert.DeserializeObject<ResponseError>(body);
        ...
        public async Task UpdateShouldFailWhenQueryApiVersionIsMissing()
        {
            ...
            // Act
            _client.DefaultRequestHeaders.Add("If-Match", ifmatch);
            var response = await _client.PatchAsync(string.Format("api/sources/{0}", routeId), new StringContent(jsonInString, Encoding.UTF8, "application/json"));
            var body = await response.Content.ReadAsStringAsync();
            var error = JsonConvert.DeserializeObject<ResponseError>(body);
            ...
            var expectedError = new ResponseError
            {
                Error = new ResponseErrorBody
                {
                    ...
                    Details = new List<ResponseErrorField>
                    {
                        ...
                        {
                            Code = "invalid-input",
                            Message = ValidationFailures.SourceNameCannotBeEmpty,
                            Target = "name"
                        }
                    }
                }
        ...
        public async Task UpdateShouldFailWhenNameAlreadyExists()
        {
            ...
            var apiVersion = "1.0";
            await ControllerHelper.CreateSource(nameFirst, description);
            var createdRecordResult = await ControllerHelper.CreateSource(nameSecond, description);
            var routeId = createdRecordResult.Id;
            var ifmatch = createdRecordResult.ETag;
        ...
        public async Task DeleteShouldSucceed()
        {
            ...
            // Act
            _client.DefaultRequestHeaders.Add("If-Match", ifmatch);
            var response = await _client.DeleteAsync(string.Format("api/sources/{0}?api-version={1}", routeId, apiVersion));
            var body = await response.Content.ReadAsStringAsync();
        ...
        public async Task DeleteShouldFailWhenQueryApiVersionIsMissing()
        {
            ...
            // Act
            var response = await _client.DeleteAsync(string.Format("api/sources/{0}", routeId));
            var body = await response.Content.ReadAsStringAsync();
            var error = JsonConvert.DeserializeObject<ResponseError>(body);
