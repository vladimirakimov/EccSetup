...
namespace ITG.Brix.EccSetup.IntegrationTests.Controllers
{
    ...
    public class BusinessUnitsControllerTests
    {
        ...
        {
            DatabaseHelper.Init("BusinessUnits");
        ...
        public async Task ListAllShouldSucceed()
        {
            // Arrange
            var apiVersion = "1.0";
            await ControllerHelper.CreateBusinessUnit("Name");

            // Act
            var response = await _client.GetAsync(string.Format("api/businessunits?api-version={0}", apiVersion));
            var responseBody = await response.Content.ReadAsStringAsync();
            var businessUnitsModel = JsonConvert.DeserializeObject<BusinessUnitsModel>(responseBody);

            // Assert
            response.StatusCode.Should().Be(HttpStatusCode.OK);
            businessUnitsModel.Value.Should().HaveCount(1);
            businessUnitsModel.Count.Should().Be(1);
        ...
        public async Task ListWithFilterShouldSucceed(string filter, int countResult)
        {
            ...
            {
                await ControllerHelper.CreateBusinessUnit(name + c);
            }

            // Act
            var response = await _client.GetAsync(string.Format("api/businessunits?api-version={0}&$filter={1}", apiVersion, filter));
            var responseBody = await response.Content.ReadAsStringAsync();
            var businessUnitsModel = JsonConvert.DeserializeObject<BusinessUnitsModel>(responseBody);
        ...
        public async Task ListWithSkipAndTopShouldSucceed(int skip, int top, int countResult)
        {
            ...
            // Act
            var response = await _client.GetAsync(string.Format("api/businessunits?api-version={0}&$skip={1}&$top={2}", apiVersion, skip, top));
            var responseBody = await response.Content.ReadAsStringAsync();
            var businessUnitsModel = JsonConvert.DeserializeObject<BusinessUnitsModel>(responseBody);
        ...
        public async Task ListWithFilterSkipTopShouldSucceed(string filter, int skip, int top, int countResult)
        {
            ...
            // Act
            var response = await _client.GetAsync(string.Format("api/businessunits?api-version={0}&$filter={1}&$skip={2}&$top={3}", apiVersion, filter, skip, top));
            var responseBody = await response.Content.ReadAsStringAsync();
            var businessUnitsModel = JsonConvert.DeserializeObject<BusinessUnitsModel>(responseBody);
        ...
        public async Task ListShouldSucceedWhenQueryTopPresentButUnset(string top)
        {
            ...
            // Act
            var response = await _client.GetAsync(string.Format("api/businessunits?api-version={0}&$top={1}", apiVersion, top));
        ...
        public async Task ListShouldSucceedWhenQuerySkipPresentButUnset(string skip)
        {
            ...
            // Act
            var response = await _client.GetAsync(string.Format("api/businessunits?api-version={0}&$skip={1}", apiVersion, skip));
        ...
        public async Task ListShouldFailWhenQueryApiVersionIsMissing()
        {
            ...
            // Act
            var response = await _client.GetAsync("api/businessunits");
            var body = await response.Content.ReadAsStringAsync();
            var error = JsonConvert.DeserializeObject<ResponseError>(body);
        ...
        public async Task GetShouldSucceed()
        {
            ...
            var createdRecordResult = await ControllerHelper.CreateBusinessUnit(name);
            var routeId = createdRecordResult.Id;
            var eTag = createdRecordResult.ETag;

            // Act
            var response = await _client.GetAsync(string.Format("api/businessunits/{0}?api-version={1}", routeId, apiVersion));
            var responseBody = await response.Content.ReadAsStringAsync();
            var businessUnitModel = JsonConvert.DeserializeObject<BusinessUnitModel>(responseBody);
        ...
        public async Task GetShouldFailWhenRouteIdIsInvalid()
        {
            ...
            // Act
            var response = await _client.GetAsync(string.Format("api/businessunits/{0}", routeId));
            var body = await response.Content.ReadAsStringAsync();
            var error = JsonConvert.DeserializeObject<ResponseError>(body);
            ...
            var expectedError = new ResponseError
            {
                Error = new ResponseErrorBody
                {
                    ...
                    Details = new List<ResponseErrorField>
                    {
                        ...
                        {
                            Code = Consts.Failure.Detail.Code.NotFound,
                            Message = CustomFailures.BusinessUnitNotFound,
                            Target = Consts.Failure.Detail.Target.Id
                        }
                    }
                }
        ...
        public async Task CreateShouldFailWhenBodyIsNonJsonContentType()
        {
            ...
            // Act
            var response = await _client.PostAsync(string.Format("api/businessunits?api-version={0}", apiVersion), new StringContent(jsonBody, Encoding.UTF8, "text/plain"));
            var responseBody = await response.Content.ReadAsStringAsync();
        ...
        public async Task CreateShouldFailWhenQueryApiVersionIsMissing()
        {
            ...
            // Act
            var response = await _client.PostAsync("api/businessunits", new StringContent(jsonBody, Encoding.UTF8, "application/json"));
            var responseBody = await response.Content.ReadAsStringAsync();
            ...
            var expectedError = new ResponseError
            {
                Error = new ResponseErrorBody
                {
                    ...
                    Details = new List<ResponseErrorField>
                    {
                        ...
                        {
                            Code = "invalid-input",
                            Message = ValidationFailures.BusinessUnitNameMandatory,
                            Target = "name"
                        }
                    }
                }
            ...
            var expectedError = new ResponseError
            {
                Error = new ResponseErrorBody
                {
                    ...
                    Details = new List<ResponseErrorField>
                    {
                        ...
                        {
                            Code = "invalid-input",
                            Message = ValidationFailures.BusinessUnitNameCannotStartOrEndWithWhiteSpace,
                            Target = "name"
                        }
                    }
                }
        ...
        public async Task UpdateShouldSucceed()
        {
            ...
            var response = await _client.PatchAsync(string.Format("api/businessunits/{0}?api-version={1}", routeId, apiVersion), new StringContent(jsonInString, Encoding.UTF8, "application/json"));
            var body = await response.Content.ReadAsStringAsync();
        ...
        public async Task UpdateShouldFailWhenBodyIsNonJsonContentType()
        {
            ...
            // Act
            _client.DefaultRequestHeaders.Add("If-Match", ifmatch);
            var response = await _client.PatchAsync(string.Format("api/businessunits/{0}?api-version={1}", routeId, apiVersion), new StringContent(jsonInString, Encoding.UTF8, "text/plain"));
            var body = await response.Content.ReadAsStringAsync();
            var error = JsonConvert.DeserializeObject<ResponseError>(body);
        ...
        public async Task UpdateShouldFailWhenQueryApiVersionIsMissing()
        {
            ...
            // Act
            _client.DefaultRequestHeaders.Add("If-Match", ifmatch);
            var response = await _client.PatchAsync(string.Format("api/businessunits/{0}", routeId), new StringContent(jsonInString, Encoding.UTF8, "application/json"));
            var body = await response.Content.ReadAsStringAsync();
            var error = JsonConvert.DeserializeObject<ResponseError>(body);
            ...
            var expectedError = new ResponseError
            {
                Error = new ResponseErrorBody
                {
                    ...
                    Details = new List<ResponseErrorField>
                    {
                        ...
                        {
                            Code = "invalid-input",
                            Message = ValidationFailures.BusinessUnitNameCannotBeEmpty,
                            Target = "name"
                        }
                    }
                }
        ...
        public async Task UpdateShouldFailWhenNameAlreadyExists()
        {
            ...
            var apiVersion = "1.0";
            await ControllerHelper.CreateBusinessUnit(nameFirst);
            var createdRecordResult = await ControllerHelper.CreateBusinessUnit(nameSecond);
            var routeId = createdRecordResult.Id;
            var ifmatch = createdRecordResult.ETag;
        ...
        public async Task DeleteShouldSucceed()
        {
            ...
            // Act
            _client.DefaultRequestHeaders.Add("If-Match", ifmatch);
            var response = await _client.DeleteAsync(string.Format("api/businessunits/{0}?api-version={1}", routeId, apiVersion));
            var body = await response.Content.ReadAsStringAsync();
        ...
        public async Task DeleteShouldFailWhenQueryApiVersionIsMissing()
        {
            ...
            // Act
            var response = await _client.DeleteAsync(string.Format("api/businessunits/{0}", routeId));
            var body = await response.Content.ReadAsStringAsync();
            var error = JsonConvert.DeserializeObject<ResponseError>(body);
