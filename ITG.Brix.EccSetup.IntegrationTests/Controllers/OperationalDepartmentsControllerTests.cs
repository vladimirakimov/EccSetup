...
namespace ITG.Brix.EccSetup.IntegrationTests.Controllers
{
    ...
    public class OperationalDepartmentsControllerTests
    {
        ...
        {
            DatabaseHelper.Init("OperationalDepartments");
        ...
        public async Task ListAllShouldSucceed()
        {
            // Arrange
            var apiVersion = "1.0";
            await ControllerHelper.CreateOperationalDepartment("TestCode", "TestName", "TSite", "TestSource");

            // Act
            var response = await _client.GetAsync(string.Format("api/operationaldepartments?api-version={0}", apiVersion));
            var responseBody = await response.Content.ReadAsStringAsync();
            var operationalDepartmentsModel = JsonConvert.DeserializeObject<OperationalDepartmentsModel>(responseBody);

            // Assert
            response.StatusCode.Should().Be(HttpStatusCode.OK);
            operationalDepartmentsModel.Value.Should().HaveCount(1);
            operationalDepartmentsModel.Count.Should().Be(1);
            operationalDepartmentsModel.NextLink.Should().BeNull();
        }
        ...
        public async Task ListShouldFailWhenQueryApiVersionIsMissing()
        {
            ...
            // Act
            var response = await _client.GetAsync("api/operationaldepartments");
        ...
        public async Task ListWithFilterShouldSucceed(string filter, int countResult)
        {
            ...
            {
                await ControllerHelper.CreateOperationalDepartment(code + c, name, site, source);
            }

            // Act
            var response = await _client.GetAsync(string.Format("api/operationaldepartments?api-version={0}&$filter={1}", apiVersion, filter));
            var responseBody = await response.Content.ReadAsStringAsync();
            var operationalDepartmentsModel = JsonConvert.DeserializeObject<OperationalDepartmentsModel>(responseBody);

            // Assert
            response.StatusCode.Should().Be(HttpStatusCode.OK);
            operationalDepartmentsModel.Value.Should().HaveCount(countResult);
            operationalDepartmentsModel.Count.Should().Be(countResult);
            operationalDepartmentsModel.NextLink.Should().BeNull();
        }
        ...
        public async Task ListWithSkipAndTopShouldSucceed(int skip, int top, int countResult)
        {
            ...
            // Act
            var response = await _client.GetAsync(string.Format("api/operationaldepartments?api-version={0}&$skip={1}&$top={2}", apiVersion, skip, top));
            var responseBody = await response.Content.ReadAsStringAsync();
            var operationalDepartmentsModel = JsonConvert.DeserializeObject<OperationalDepartmentsModel>(responseBody);
        ...
        public async Task ListWithFilterSkipTopShouldSucceed(string filter, int skip, int top, int countResult)
        {
            ...
            // Act
            var response = await _client.GetAsync(string.Format("api/operationaldepartments?api-version={0}&$filter={1}&$skip={2}&$top={3}", apiVersion, filter, skip, top));
            var responseBody = await response.Content.ReadAsStringAsync();
            var operationalDepartmentsModel = JsonConvert.DeserializeObject<OperationalDepartmentsModel>(responseBody);
        ...
        public async Task ListShouldSucceedWhenQueryTopPresentButUnset(string top)
        {
            ...
            // Act
            var response = await _client.GetAsync(string.Format("api/operationaldepartments?api-version={0}&$top={1}", apiVersion, top));
        ...
        public async Task ListShouldSucceedWhenQuerySkipPresentButUnset(string skip)
        {
            ...
            // Act
            var response = await _client.GetAsync(string.Format("api/operationaldepartments?api-version={0}&$skip={1}", apiVersion, skip));
        ...
        public async Task CreateShouldFailWhenBodyIsNonJsonContentType()
        {
            ...
            // Act
            var response = await _client.PostAsync(string.Format("api/operationaldepartments?api-version={0}", apiVersion), new StringContent(jsonBody, Encoding.UTF8, "text/plain"));
            var responseBody = await response.Content.ReadAsStringAsync();
        ...
        public async Task CreateShouldFailWhenQueryApiVersionIsMissing()
        {
            ...
            // Act
            var response = await _client.PostAsync("api/operationaldepartments", new StringContent(jsonBody, Encoding.UTF8, "application/json"));
            var responseBody = await response.Content.ReadAsStringAsync();
            ...
            var expectedError = new ResponseError
            {
                Error = new ResponseErrorBody
                {
                    ...
                    Details = new List<ResponseErrorField>
                    {
                        ...
                        {
                            Code = "invalid-input",
                            Message = ValidationFailures.OperationalDepartmentSiteMandatory,
                            Target = "site"
                        }
                    }
                }
        ...
        [TestMethod]
        public async Task CreateShouldFailWhenSiteIsEmpty()
        {
            // Arrange
            var name = "TName";
            var code = "TCode";
        ...
        [TestMethod]
        public async Task CreateShouldFailWhenSiteIsWhiteSpace()
        {
            // Arrange
            var name = "TName";
            var code = "TCode";
            ...
            var expectedError = new ResponseError
            {
                Error = new ResponseErrorBody
                {
                    ...
                    Details = new List<ResponseErrorField>
                    {
                        ...
                        {
                            Code = "invalid-input",
                            Message = ValidationFailures.OperationalDepartmentCodeMandatory,
                            Target = "code"
                        }
                    }
                }
            ...
            var expectedError = new ResponseError
            {
                Error = new ResponseErrorBody
                {
                    ...
                    Details = new List<ResponseErrorField>
                    {
                        ...
                        {
                            Code = "invalid-input",
                            Message = ValidationFailures.OperationalDepartmentSourceMandatory,
                            Target = "source"
                        }
                    }
                }
        ...
        [TestMethod]
        public async Task CreateShouldFailWhenCodeAndSourceAndSiteAlreadyExists()
        {
            // Arrange
            var name = "TName";
            var code = "TCode";
            ...
            var site = "TSite";
            var apiVersion = "1.0";
            await ControllerHelper.CreateOperationalDepartment(code, name, site, source);
