...
namespace ITG.Brix.EccSetup.IntegrationTests.Controllers
{
    ...
    public class TransportTypesControllerTests
    {
        ...
        {
            DatabaseHelper.Init("TransportTypes");
        ...
        public async Task ListAllShouldSucceed()
        {
            // Arrange
            var apiVersion = "1.0";
            await ControllerHelper.CreateTransportType("TestCode", "TestName", "TestSource");

            // Act
            var response = await _client.GetAsync(string.Format("api/transporttypes?api-version={0}", apiVersion));
            var responseBody = await response.Content.ReadAsStringAsync();
            var transportTypesModel = JsonConvert.DeserializeObject<TransportTypesModel>(responseBody);

            // Assert
            response.StatusCode.Should().Be(HttpStatusCode.OK);
            transportTypesModel.Value.Should().HaveCount(1);
            transportTypesModel.Count.Should().Be(1);
            transportTypesModel.NextLink.Should().BeNull();
        }
        ...
        public async Task ListShouldFailWhenQueryApiVersionIsMissing()
        {
            ...
            // Act
            var response = await _client.GetAsync("api/transporttypes");
        ...
        public async Task ListWithFilterShouldSucceed(string filter, int countResult)
        {
            ...
            {
                await ControllerHelper.CreateTransportType(code + c, name, source);
            }

            // Act
            var response = await _client.GetAsync(string.Format("api/transporttypes?api-version={0}&$filter={1}", apiVersion, filter));
            var responseBody = await response.Content.ReadAsStringAsync();
            var transportTypesModel = JsonConvert.DeserializeObject<TransportTypesModel>(responseBody);

            // Assert
            response.StatusCode.Should().Be(HttpStatusCode.OK);
            transportTypesModel.Value.Should().HaveCount(countResult);
            transportTypesModel.Count.Should().Be(countResult);
            transportTypesModel.NextLink.Should().BeNull();
        }
        ...
        public async Task ListWithSkipAndTopShouldSucceed(int skip, int top, int countResult)
        {
            ...
            // Act
            var response = await _client.GetAsync(string.Format("api/transporttypes?api-version={0}&$skip={1}&$top={2}", apiVersion, skip, top));
            var responseBody = await response.Content.ReadAsStringAsync();
            var transportTypesModel = JsonConvert.DeserializeObject<TransportTypesModel>(responseBody);
        ...
        public async Task ListWithFilterSkipTopShouldSucceed(string filter, int skip, int top, int countResult)
        {
            ...
            // Act
            var response = await _client.GetAsync(string.Format("api/transporttypes?api-version={0}&$filter={1}&$skip={2}&$top={3}", apiVersion, filter, skip, top));
            var responseBody = await response.Content.ReadAsStringAsync();
            var transportTypesModel = JsonConvert.DeserializeObject<TransportTypesModel>(responseBody);
        ...
        public async Task ListShouldSucceedWhenQueryTopPresentButUnset(string top)
        {
            ...
            // Act
            var response = await _client.GetAsync(string.Format("api/transporttypes?api-version={0}&$top={1}", apiVersion, top));
        ...
        public async Task ListShouldSucceedWhenQuerySkipPresentButUnset(string skip)
        {
            ...
            // Act
            var response = await _client.GetAsync(string.Format("api/transporttypes?api-version={0}&$skip={1}", apiVersion, skip));
        ...
        public async Task CreateShouldFailWhenBodyIsNonJsonContentType()
        {
            ...
            // Act
            var response = await _client.PostAsync(string.Format("api/transporttypes?api-version={0}", apiVersion), new StringContent(jsonBody, Encoding.UTF8, "text/plain"));
            var responseBody = await response.Content.ReadAsStringAsync();
        ...
        public async Task CreateShouldFailWhenQueryApiVersionIsMissing()
        {
            ...
            // Act
            var response = await _client.PostAsync("api/transporttypes", new StringContent(jsonBody, Encoding.UTF8, "application/json"));
            var responseBody = await response.Content.ReadAsStringAsync();
            ...
            var expectedError = new ResponseError
            {
                Error = new ResponseErrorBody
                {
                    ...
                    Details = new List<ResponseErrorField>
                    {
                        ...
                        {
                            Code = "invalid-input",
                            Message = ValidationFailures.TransportTypeCodeMandatory,
                            Target = "code"
                        }
                    }
                }
            ...
            var expectedError = new ResponseError
            {
                Error = new ResponseErrorBody
                {
                    ...
                    Details = new List<ResponseErrorField>
                    {
                        ...
                        {
                            Code = "invalid-input",
                            Message = ValidationFailures.TransportTypeSourceMandatory,
                            Target = "source"
                        }
                    }
                }
            ...
            var expectedError = new ResponseError
            {
                Error = new ResponseErrorBody
                {
                    ...
                    Details = new List<ResponseErrorField>
                    {
                        ...
                        {
                            Code = "invalid-input",
                            Message = ValidationFailures.TransportTypeNameMandatory,
                            Target = "name"
                        }
                    }
                }
        ...
        public async Task CreateShouldFailWhenCodeAndNameAndSourceAlreadyExists()
        {
            ...
            string source = "TSource";
            var apiVersion = "1.0";
            await ControllerHelper.CreateTransportType(code, name, source);
