...
namespace ITG.Brix.EccSetup.UnitTests.Infrastructure.Repositories
{
    [TestClass]
    public class InstructionsWriteRepositoryTests
    {
        [TestMethod]
        public void CtorShouldSucceed()
        {
            ...
            // Act
            Action ctor = () => { new InstructionWriteRepository(dataContext); };
