...
namespace ITG.Brix.EccSetup.UnitTests.Infrastructure.Repositories.Configurations
{
    [TestClass]
    public class OperationWriteRepositoryTests
    {
        ...
        public void CtorShouldSucceed()
        {
            ...
            // Act
            Action ctor = () => { new OperationReadRepository(dataContext); };
        ...
        [TestMethod]
        public void CtorShouldFailWhenDataContextnNull()
        {
            // Arrange
            DataContext dataContext = null;

            // Act
            Action ctor = () => { new OperationWriteRepository(dataContext); };
