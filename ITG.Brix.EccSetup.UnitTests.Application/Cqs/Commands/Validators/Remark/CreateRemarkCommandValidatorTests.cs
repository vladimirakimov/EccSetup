...
{
    [TestClass]
    public class CreateRemarkCommandValidatorTests
    {
        private CreateRemarkCommandValidator _validator;

        [TestInitialize]
        public void TestInitialize()
        {
            _validator = new CreateRemarkCommandValidator();
        }
        ...
        public void ShouldContainNoErrors()
        {
            ...
            var command = new CreateRemarkCommand(name, nameOnAplication, description, icon, tags, defaultRemarks);
