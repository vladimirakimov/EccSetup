...
{
    [TestClass]
    public class DeleteValidationCommandValidatorTests
    {
        private DeleteValidationCommandValidator _validator;

        [TestInitialize]
        public void TestInitialize()
        {
            _validator = new DeleteValidationCommandValidator();
        }
        ...
        public void ShouldContainNoErrors()
        {
            ...
            var command = new DeleteValidationCommand(id, version);
