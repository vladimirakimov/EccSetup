...
{
    [TestClass]
    public class DeleteInputCommandValidatorTests
    {
        private DeleteInputCommandValidator _validator;

        [TestInitialize]
        public void TestInitialize()
        {
            _validator = new DeleteInputCommandValidator();
        }
        ...
        public void ShouldContainNoErrors()
        {
            ...
            var command = new DeleteInputCommand(id, version);
