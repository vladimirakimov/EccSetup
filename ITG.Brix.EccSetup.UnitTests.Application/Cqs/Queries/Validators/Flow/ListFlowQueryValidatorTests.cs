...
{
    [TestClass]
    public class ListFlowQueryValidatorTests
    {
        private ListFlowQueryValidator _validator;

        [TestInitialize]
        public void TestInitialize()
        {
            _validator = new ListFlowQueryValidator();
        }
        ...
        public void ShouldContainNoErrors()
        {
            ...
            string top = null;
            string skip = null;
            var query = new ListFlowQuery(filter, top, skip);
