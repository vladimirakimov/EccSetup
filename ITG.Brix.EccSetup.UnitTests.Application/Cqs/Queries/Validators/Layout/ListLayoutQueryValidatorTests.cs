...
{
    [TestClass]
    public class ListLayoutQueryValidatorTests
    {
        private ListLayoutQueryValidator _validator;

        [TestInitialize]
        public void TestInitialize()
        {
            _validator = new ListLayoutQueryValidator();
        }
        ...
        public void ShouldContainNoErrors()
        {
            ...
            string top = null;
            string skip = null;
            var query = new ListLayoutQuery(filter, top, skip);
