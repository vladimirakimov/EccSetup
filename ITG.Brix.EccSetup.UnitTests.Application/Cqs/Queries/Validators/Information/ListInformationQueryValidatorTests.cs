...
{
    [TestClass]
    public class ListInformationQueryValidatorTests
    {
        private ListInformationQueryValidator _validator;

        [TestInitialize]
        public void TestInitialize()
        {
            _validator = new ListInformationQueryValidator();
        }
        ...
        public void ShouldContainNoErrors()
        {
            ...
            string top = null;
            string skip = null;
            var query = new ListInformationQuery(filter, top, skip);
