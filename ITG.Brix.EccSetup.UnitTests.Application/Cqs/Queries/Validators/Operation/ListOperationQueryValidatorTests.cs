...
{
    [TestClass]
    public class ListOperationQueryValidatorTests
    {
        private ListOperationQueryValidator _validator;

        [TestInitialize]
        public void TestInitialize()
        {
            _validator = new ListOperationQueryValidator();
        }
        ...
        public void ShouldContainNoErrors()
        {
            ...
            string top = null;
            string skip = null;
            var query = new ListOperationQuery(filter, top, skip);
