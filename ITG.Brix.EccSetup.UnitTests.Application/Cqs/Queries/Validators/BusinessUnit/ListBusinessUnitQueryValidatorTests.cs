...
{
    [TestClass]
    public class ListBusinessUnitQueryValidatorTests
    {
        private ListBusinessUnitQueryValidator _validator;

        [TestInitialize]
        public void TestInitialize()
        {
            _validator = new ListBusinessUnitQueryValidator();
        }
        ...
        public void ShouldContainNoErrors()
        {
            ...
            string top = null;
            string skip = null;
            var query = new ListBusinessUnitQuery(filter, top, skip);
