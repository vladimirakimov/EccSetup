...
{
    [TestClass]
    public class ListRemarkQueryValidatorTests
    {
        private ListRemarkQueryValidator _validator;

        [TestInitialize]
        public void TestInitialize()
        {
            _validator = new ListRemarkQueryValidator();
        }
        ...
        public void ShouldContainNoErrors()
        {
            ...
            string top = null;
            string skip = null;
            var query = new ListRemarkQuery(filter, top, skip);
