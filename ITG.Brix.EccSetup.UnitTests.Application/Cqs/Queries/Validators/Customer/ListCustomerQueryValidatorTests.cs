...
{
    [TestClass]
    public class ListCustomerQueryValidatorTests
    {
        private ListCustomerQueryValidator _validator;

        [TestInitialize]
        public void TestInitialize()
        {
            _validator = new ListCustomerQueryValidator();
        }
        ...
        public void ShouldContainNoErrors()
        {
            ...
            string top = null;
            string skip = null;
            var query = new ListCustomerQuery(filter, top, skip);
