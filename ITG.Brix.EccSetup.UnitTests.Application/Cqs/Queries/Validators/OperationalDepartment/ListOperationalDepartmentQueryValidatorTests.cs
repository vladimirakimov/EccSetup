...
using ITG.Brix.EccSetup.Application.Cqs.Queries.Validators.OperationalDepartments;
using ITG.Brix.EccSetup.Application.Resources;
using Microsoft.VisualStudio.TestTools.UnitTesting;
using System.Linq;

namespace ITG.Brix.EccSetup.UnitTests.Application.Cqs.Queries.Validators.OperationalDepartment
{
    [TestClass]
    public class ListOperationalDepartmentQueryValidatorTests
    {
        private ListOperationalDepartmentQueryValidator _validator;

        [TestInitialize]
        public void TestInitialize()
        {
            _validator = new ListOperationalDepartmentQueryValidator();
        }
        ...
        public void ShouldContainNoErrors()
        {
            ...
            string top = null;
            string skip = null;
            var query = new ListOperationalDepartmentQuery(filter, top, skip);
