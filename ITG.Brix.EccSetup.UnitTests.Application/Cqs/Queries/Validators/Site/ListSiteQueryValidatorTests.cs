...
namespace ITG.Brix.EccSetup.UnitTests.Application.Cqs.Queries.Validators.Site
{
    [TestClass]
    public class ListSiteQueryValidatorTests
    {
        private ListSiteQueryValidator _validator;

        [TestInitialize]
        public void TestInitialize()
        {
            _validator = new ListSiteQueryValidator();
        }
        ...
        public void ShouldContainNoErrors()
        {
            ...
            string top = null;
            string skip = null;
            var query = new ListSiteQuery(filter, top, skip);
