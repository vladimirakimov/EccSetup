...
{
    [TestClass]
    public class ListStorageStatusQueryValidatorTests
    {
        private ListStorageStatusQueryValidator _validator;

        [TestInitialize]
        public void TestInitialize()
        {
            _validator = new ListStorageStatusQueryValidator();
        }
        ...
        public void ShouldContainNoErrors()
        {
            ...
            string top = null;
            string skip = null;
            var query = new ListStorageStatusQuery(filter, top, skip);
