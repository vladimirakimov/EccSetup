...
namespace ITG.Brix.EccSetup.UnitTests.Application.Cqs.Queries.Validators.TypePlanning
{
    [TestClass]
    public class ListTypePlanningQueryValidatorTests
    {
        private ListTypePlanningQueryValidator _validator;

        [TestInitialize]
        public void TestInitialize()
        {
            _validator = new ListTypePlanningQueryValidator();
        }
        ...
        public void ShouldContainNoErrors()
        {
            ...
            string top = null;
            string skip = null;
            var query = new ListTypePlanningQuery(filter, top, skip);
