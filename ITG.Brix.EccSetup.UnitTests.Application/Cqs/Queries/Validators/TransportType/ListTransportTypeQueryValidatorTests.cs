...
namespace ITG.Brix.EccSetup.UnitTests.Application.Cqs.Queries.Validators.TransportType
{
    [TestClass]
    public class ListTransportTypeQueryValidatorTests
    {
        private ListTransportTypeQueryValidator _validator;

        [TestInitialize]
        public void TestInitialize()
        {
            _validator = new ListTransportTypeQueryValidator();
        }
        ...
        public void ShouldContainNoErrors()
        {
            ...
            string top = null;
            string skip = null;
            var query = new ListTransportTypeQuery(filter, top, skip);
