...
{
    [TestClass]
    public class ListChecklistQueryValidatorTests
    {
        private ListChecklistQueryValidator _validator;

        [TestInitialize]
        public void TestInitialize()
        {
            _validator = new ListChecklistQueryValidator();
        }
        ...
        public void ShouldContainNoErrors()
        {
            ...
            string top = null;
            string skip = null;
            var query = new ListChecklistQuery(filter, top, skip);
