...
{
    [TestClass]
    public class ListInputQueryValidatorTests
    {
        private ListInputQueryValidator _validator;

        [TestInitialize]
        public void TestInitialize()
        {
            _validator = new ListInputQueryValidator();
        }
        ...
        public void ShouldContainNoErrors()
        {
            ...
            string top = null;
            string skip = null;
            var query = new ListInputQuery(filter, top, skip);
