...
namespace ITG.Brix.EccSetup.UnitTests.Application.Cqs.Queries.Validators.DamageCode
{
    [TestClass]
    public class ListDamageCodeQueryValidatorTests
    {
        private ListDamageCodeQueryValidator _validator;

        [TestInitialize]
        public void TestInitialize()
        {
            _validator = new ListDamageCodeQueryValidator();
        }
        ...
        public void ShouldContainNoErrors()
        {
            ...
            string top = null;
            string skip = null;
            var query = new ListDamageCodeQuery(filter, top, skip);
