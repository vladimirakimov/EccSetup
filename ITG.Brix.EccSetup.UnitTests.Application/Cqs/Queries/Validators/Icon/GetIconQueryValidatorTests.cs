...
{
    [TestClass]
    public class GetIconQueryValidatorTests
    {
        private GetIconQueryValidator _validator;

        [TestInitialize]
        public void TestInitialize()
        {
            _validator = new GetIconQueryValidator();
        }
        ...
        {
            // Arrange
            var query = new GetIconQuery(id: Guid.NewGuid());
        ...
        {
            // Arrange
            var query = new GetIconQuery(id: Guid.Empty);
