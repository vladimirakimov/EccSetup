...
namespace ITG.Brix.EccSetup.UnitTests.Application.Cqs.Queries.Validators.ProductionSite
{
    [TestClass]
    public class ListProductionSiteQueryValidatorTests
    {
        private ListProductionSiteQueryValidator _validator;

        [TestInitialize]
        public void TestInitialize()
        {
            _validator = new ListProductionSiteQueryValidator();
        }
        ...
        public void ShouldContainNoErrors()
        {
            ...
            string top = null;
            string skip = null;
            var query = new ListProductionSiteQuery(filter, top, skip);
