...
using ITG.Brix.EccSetup.Application.Cqs.Queries.Validators.Location;
using ITG.Brix.EccSetup.Application.Resources;
using Microsoft.VisualStudio.TestTools.UnitTesting;
using System.Linq;

namespace ITG.Brix.EccSetup.UnitTests.Application.Cqs.Queries.Validators.Location
{
    [TestClass]
    public class ListLocationQueryValidatorTests
    {
        private ListLocationQueryValidator _validator;
        ...
        public void ShouldContainNoErrors()
        {
            ...
            string top = null;
            string skip = null;
            var query = new ListLocationQuery(filter, top, skip);
