...
{
    [TestClass]
    public class ListInstructionQueryValidatorTests
    {
        private ListInstructionQueryValidator _validator;

        [TestInitialize]
        public void TestInitialize()
        {
            _validator = new ListInstructionQueryValidator();
        }
        ...
        public void ShouldContainNoErrors()
        {
            ...
            string top = null;
            string skip = null;
            var query = new ListInstructionQuery(filter, top, skip);
