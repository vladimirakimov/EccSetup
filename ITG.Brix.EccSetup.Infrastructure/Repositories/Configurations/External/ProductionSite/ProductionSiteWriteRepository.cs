...
{
    public class ProductionSiteWriteRepository : BaseWriteRepository<ProductionSite>, IProductionSiteWriteRepository
    {
        private readonly DataContext _dataContext;

        public ProductionSiteWriteRepository(DataContext dataContext)
        {
