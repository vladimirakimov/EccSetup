...
{
    public class TransportTypeWriteRepository : BaseWriteRepository<TransportType>, ITransportTypeWriteRepository
    {
        private readonly DataContext _dataContext;

        public TransportTypeWriteRepository(DataContext dataContext)
        {
