...
{
    public class ScreenFilterWriteRepository : BaseWriteRepository<ScreenFilter>, IScreenFilterWriteRepository
    {
        private readonly DataContext _dataContext;

        public ScreenFilterWriteRepository(DataContext dataContext)
        {
